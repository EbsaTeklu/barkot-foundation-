...
import { Menu, X, Globe, Banknote, Phone, Mail, MapPin, Youtube, Facebook, Send, Home, Heart, Clock } from 'lucide-react'; 
    ...
    <nav className="bg-white shadow-md fixed w-full z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          <div className="flex items-center">
            ...
            {/* FIX: Always show the title on mobile now */}
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <a href="#contact" className="text-bbfBlue font-medium hover:text-bbfPurple">{t('nav.contact')}</a> {/* New Contact Link */}
      ...
      {isOpen && (
        <div className="md:hidden bg-white pb-4 px-4 shadow-lg flex flex-col space-y-2">
           ...
           <a href="#contact" onClick={()=>setIsOpen(false)} className="py-1 text-bbfBlue">{t('nav.contact')}</a> {/* Mobile Contact Link */}
